...
class Graph implements Iterable<Vertex> {
    ...
    static Graph readGraph(InputStream in, boolean b) {
	...
	// read the graph related parameters
        System.out.println("Enter the properties of the graph as follows :");
        System.out.println("<NUMBER OF VERTICES>");
        System.out.println("<NUMBER OF EDGES>");
       
        System.out.println("<LABELLED FIRST VERTEX OF nth EDGE>");
        System.out.println("<LABELLED SECOND VERTEX OF nth EDGE> \n");
